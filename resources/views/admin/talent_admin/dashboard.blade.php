                    ...
                    <div class="d-flex align-items-center p-3 mb-3 border rounded-3 bg-light hover-bg-white transition-all">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="mb-0 text-muted small">
                                ...
                                Requesting talent: <span class="fw-semibold">{{ $request->talent->user->name }}</span>
                            </p>
                        </div>
                        <div class="me-3">
                            @php
                    ...
                    <div class="d-flex align-items-center p-2 mb-3 rounded hover-bg-light transition-all">
                        <div class="me-3">
                            @if($talent->user->avatar)
                                <img class="rounded-circle shadow-sm" src="{{ asset('storage/' . $talent->user->avatar) }}"
                                     alt="{{ $talent->user->name }}" style="width: 45px; height: 45px; object-fit: cover;">
                            @else
                        ...
                        <div class="flex-grow-1">
                            <h6 class="mb-1 fw-semibold">{{ $talent->user->name }}</h6>
                            <p class="text-muted small mb-0">
                                <i class="fas fa-briefcase me-1"></i>
                                {{ $talent->user->pekerjaan ?? 'Position not specified' }}
                            </p>
                        </div>
                        <div>
                            <span class="badge {{ $talent->is_active ? 'bg-success' : 'bg-secondary' }} px-2 py-1">
                                <i class="fas fa-{{ $talent->is_active ? 'check-circle' : 'pause-circle' }} me-1"></i>
                    ...
                    <div class="d-flex align-items-center p-2 mb-3 rounded hover-bg-light transition-all">
                        <div class="me-3">
                            @if($recruiter->user->avatar)
                                <img class="rounded-circle shadow-sm" src="{{ asset('storage/' . $recruiter->user->avatar) }}"
                                     alt="{{ $recruiter->user->name }}" style="width: 45px; height: 45px; object-fit: cover;">
                            @else
                                <div class="rounded-circle bg-gradient-secondary d-flex align-items-center justify-content-center shadow-sm" style="width: 45px; height: 45px;">
                                    <i class="fas fa-building text-white"></i>
                                </div>
                        ...
                        <div class="flex-grow-1">
                            <h6 class="mb-1 fw-semibold">{{ $recruiter->user->name }}</h6>
                            <p class="text-muted small mb-0">
                                <i class="fas fa-building me-1"></i>
                                {{ $recruiter->company_name ?? $recruiter->user->pekerjaan ?? 'Company not specified' }}
                            </p>
                        </div>
                        <div>
                            <span class="badge {{ $recruiter->is_active ? 'bg-success' : 'bg-secondary' }} px-2 py-1">
                                <i class="fas fa-{{ $recruiter->is_active ? 'check-circle' : 'pause-circle' }} me-1"></i>
