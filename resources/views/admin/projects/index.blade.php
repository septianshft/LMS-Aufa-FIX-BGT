...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-gray-600 mt-2">Review and manage project requests and assignments</p>
        </div>
        <div class="flex space-x-3">
            ...
            <span class="bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm font-medium">
                {{ $closureRequestCount ?? 0 }} Closure Requests
            </span>
        </div>
    </div>
            ...
            <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200">
                <div class="p-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">
                                @if($project->recruiter)
                                    {{ $project->recruiter->company_name ?: ($project->recruiter->user->name ?? 'Unknown Company') }}
                                @else
                                    Unknown Company
                                @endif
                            </p>
                    ...
                    <div class="space-y-2 mb-4">
                        ...
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-600">Assigned Talents:</span>
                    ...
                    <div class="mb-4">
                        <div class="flex justify-between text-xs text-gray-600 mb-1">
                            <span>Start: {{ $project->expected_start_date ? $project->expected_start_date->format('M j, Y') : 'TBD' }}</span>
                            <span>End: {{ $project->expected_end_date ? $project->expected_end_date->format('M j, Y') : 'TBD' }}</span>
                        </div>
                        ...
                        <div class="bg-orange-50 border border-orange-200 rounded-lg p-3 mb-4">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm text-orange-700 font-medium">
                                    {{ $project->pendingExtensions->count() }} extension request(s) pending
                                </span>
                            </div>
                        </div>
                    @endif
                        ...
                        <div class="bg-purple-50 border border-purple-200 rounded-lg p-3 mb-4">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm text-purple-700 font-medium">
                                    Closure request pending your approval
                                </span>
                            </div>
                            @if($project->closure_reason)
                                <p class="text-purple-600 text-xs mt-2">
                                    <strong>Reason:</strong> {{ Str::limit($project->closure_reason, 100) }}
                                </p>
                            @endif
                        </div>
                    @endif
        ...
        @empty
            <div class="col-span-full">
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-sm text-gray-500">No projects match your current filter criteria.</p>
                </div>
            </div>
        @endforelse
    </div>
...
<div id="approvalModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <h3 class="text-lg font-medium text-gray-900 mb-4">Review Project</h3>
            <form id="approvalForm" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="admin_notes" rows="3"
                              ...
                              placeholder="Add any comments or requirements..."></textarea>
                </div>
...
<div id="extensionModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
            <h3 class="text-lg font-medium text-gray-900 mb-4">Review Extension Requests</h3>
        ...
        <div class="mt-3">
            ...
            <div id="closureContent">
                ...
                <div class="text-center py-8">
                    ...
                    <p class="text-gray-600">Loading closure request details...</p>
                </div>
            </div>
        </div>
    </div>
            ...
            if (data.success) {
                ...
                document.getElementById('closureContent').innerHTML = `
                    <div class="text-center py-8">
                        ...
                        <p class="text-red-600">Error loading closure request details</p>
                    </div>
                `;
            }
        })
        ...
        <div class="space-y-6">
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                        <span class="font-medium text-gray-700">Assigned Talents:</span>
                        <span class="text-gray-900">${project.assignments_count || 0}</span>
                    </div>
                    <div>
                        <span class="font-medium text-gray-700">Recruiter:</span>
                        <span class="text-gray-900">${project.recruiter_name || 'Unknown'}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
                ...
                <div class="space-y-3">
                    <div>
                        <span class="font-medium text-purple-700">Requested At:</span>
                        <span class="text-purple-900">${project.closure_requested_at || 'N/A'}</span>
                    </div>
                    ${project.closure_reason ? `
                        <div>
                            <span class="font-medium text-purple-700">Reason:</span>
            ...
            <form id="closureDecisionForm" method="POST" action="/projects/${projectId}/approve-closure">
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-4">
                    <h4 class="font-semibold text-gray-900 mb-4">Admin Decision</h4>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select name="decision" required class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500">
                                ...
                                <option value="approved">Approve Closure</option>
                                <option value="rejected">Reject Closure Request</option>
                            </select>
                        </div>
