        ...
        <div class="flex flex-col items-center gap-[30px]">
            ...
            <div class="flex flex-col gap-[10px]">
                ...
                <p class="text-center text-xl leading-[36px] text-[#F5F8FA]">
                    Pusat Unggulan IPTEKS PT IS-IoT provides high quality online courses for you to grow <br>
                    your skills and build outstanding portfolio to tackle job interviews
                </p>
            </div>
            ...
            <form method="GET" class="flex gap-4 mt-4">
                <select name="course_mode_id" class="border rounded p-2">
                    ...
                    @foreach($modes as $mode)
                        <option value="{{ $mode->id }}" {{ request('course_mode_id') == $mode->id ? 'selected' : '' }}>
                            {{ $mode->name }}
                        </option>
                    @endforeach
                </select>
                ...
                <select name="course_level_id" class="border rounded p-2">
                    ...
                    @foreach($levels as $level)
                        <option value="{{ $level->id }}" {{ request('course_level_id') == $level->id ? 'selected' : '' }}>
                            {{ $level->name }}
                        </option>
                    @endforeach
                </select>
    ...
    <section id="Pricing" class="max-w-[1200px] mx-auto flex justify-between items-center p-[70px_100px]">
        <div class="relative">
            ...
            <div class="absolute w-[230px] transform -translate-y-1/2 top-1/2 left-[214px] bg-white z-10 rounded-[20px] gap-4 p-4 flex flex-col shadow-[0_17px_30px_0_#0D051D0A]">
                ...
                <div class="flex gap-2 items-center">
                    <div><img src="assets/icon/video-play.svg" alt="icon"></div>
                    <p class="font-medium">Videos</p>
                </div>
                <div class="flex gap-2 items-center">
                    <div><img src="assets/icon/note-favorite.svg" alt="icon"></div>
                    <p class="font-medium">Handbook</p>
                </div>
                <div class="flex gap-2 items-center">
                    <div><img src="assets/icon/3dcube.svg" alt="icon"></div>
                    <p class="font-medium">Assets</p>
                </div>
                <div class="flex gap-2 items-center">
                    <div><img src="assets/icon/award.svg" alt="icon"></div>
                    <p class="font-medium">Certificates</p>
                </div>
                <div class="flex gap-2 items-center">
                    <div><img src="assets/icon/book.svg" alt="icon"></div>
        ...
        <div class="flex flex-col text-left gap-[30px]">
            ...
            <p class="text-[#475466] text-lg leading-[34px]">
                Growing new skills would be more flexible without <br> limit we help you to access all course materials.
            </p>
                    ...
                    @for($i = 0; $i < 4; $i++)
                        <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                            ...
                            <div class="flex gap-[2px]">
                                @for($j = 0; $j < 5; $j++)
                                    <div><img src="assets/icon/star.svg" alt="star"></div>
                                @endfor
                            </div>
                        </div>
                    @endfor
    ...
    <section id="FAQ" class="max-w-[1200px] mx-auto flex flex-col py-[70px] px-[100px]">
        <div class="flex justify-between items-center">
            ...
            <div class="flex flex-col gap-[30px] w-[552px] shrink-0">
                @php
                    $faqs = [
                        ['id' => 1, 'question' => 'Can beginner join the course?', 'answer' => 'Yes, we have provided a variety range of course from beginner to intermediate level to prepare your next big career,'],
                        ['id' => 2, 'question' => 'How long does the implementation take?', 'answer' => 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolore placeat ut nostrum aperiam mollitia tempora aliquam perferendis explicabo eligendi commodi.'],
                        ['id' => 3, 'question' => 'Do you provide the job-guarantee program?', 'answer' => 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae itaque facere ipsum animi sunt iure!'],
                        ['id' => 4, 'question' => 'How to issue all course certificates?', 'answer' => 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae itaque facere ipsum animi sunt iure!']
                    ];
                @endphp
                ...
                @foreach($faqs as $faq)
                    <div class="flex flex-col p-5 rounded-2xl bg-[#FFF8F4] has-[.hide]:bg-transparent border-t-4 border-[#FF6129] has-[.hide]:border-0 w-full">
                        ...
                        <div id="accordion-faq-{{ $faq['id'] }}" class="accordion-content hide">
