        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-col gap-y-10 md:flex-row justify-between items-center">
                    ...
                    <div class="flex flex-col gap-y-3">
                        ...
                        <div>
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">{{$trainees}}</h3>
                        </div>
                    </div>
                    <div class="flex flex-col gap-y-3">
                        <svg width="46" height="46" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div>
                            <p class="text-slate-500 text-sm">Trainers</p>
                            <h3 class="text-indigo-950 text-xl font-bold">{{$trainers}}</h3>
                        </div>
                    </div>
                    <div class="flex flex-col gap-y-3">
                        <svg width="46" height="46" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p class="text-slate-500 text-base">
                    Grow your career with experienced trainers in PUI PT IS-IoT Class.
                </p>
