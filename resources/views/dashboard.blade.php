@extends('layout.template.mainTemplate') {{-- Pastikan path ini benar, jika mainTemplate ada di resources/views/layouts/mainTemplate.blade.php --}}
            ...
            <div class="row  align-items-center g-5 py-5">
                ...
                <div class="col-lg-3 col-6">
                    <div class="p-4 border border-primary rounded-2">
                        <div class="text-center">
                            <img src="{{ url('/asset/icon/user-graduate.svg') }}" alt="" class="img-fluid w-50" srcset="" width="100px" style="max-width: 100px;"> {{-- Path icon mungkin perlu disesuaikan --}}
                            <br>
                            ...
                            <h1 class="display-3 text-primary fw-bold d-block">{{ $totalTrainees ?? 'N/A' }}</h1> 
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3  col-6">
                    <div class="p-4 border border-primary rounded-2">
                        <div class="text-center">
                            <img src="{{ url('/asset/icon/chalkboard-user.svg') }}" alt="" class="img-fluid w-50" srcset="" width="100px" style="max-width: 100px;"> {{-- Path icon mungkin perlu disesuaikan --}}
                            <br>
                ...
                <div class="col-lg-3 col-6">
                    <div class="p-4 border border-primary rounded-2">
                        <div class="text-center">
                            <img src="{{ url('/asset/icon/book-open-reader.svg') }}" alt="" class="img-fluid w-50" srcset="" width="100px" style="max-width: 100px;"> {{-- Path icon mungkin perlu disesuaikan --}}
                            <br>
                            <Strong class="fs-5 text-primary d-block">Total Kursus</Strong>
                            <span class="small d-block">Semua kursus</span>
                            {{-- Ganti dengan variabel yang sesuai dari controller, contoh: --}}
                            <h1 class="display-3 text-primary fw-bold d-block">{{ $courses->count() ?? 'N/A' }}</h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6">
                    <div class="p-4 border border-primary rounded-2">
                        <div class="text-center">
                            <img src="{{ url('/asset/icon/layer-group.svg') }}" alt="" class="img-fluid w-50" srcset="" width="100px" style="max-width: 100px;"> {{-- Path icon mungkin perlu disesuaikan --}}
                            <br>
                ...
                <div class="col-lg-3 col-6">
                    <div class="p-4 border border-primary rounded-2">
                        <div class="text-center">
                            <img src="{{ url('/asset/icon/file-signature.svg') }}" alt="" class="img-fluid w-50" srcset="" width="100px" style="max-width: 100px;"> {{-- Path icon mungkin perlu disesuaikan --}}
                            <br>
