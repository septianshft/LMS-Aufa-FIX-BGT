...
use App\Models\User;
use App\Models\Ta// Test 6: Verify key test accounts
echo "6️⃣ Testing Key Test Accounts...\n";
$testAccounts = [
    'admin@admin.com' => 'Admin',
    'talentadmin@test.com' => 'Talent Admin',  // Fixed: no underscore
...
echo "🎯 TALENT PLATFORM VERIFICATION TEST\n";
echo "=====================================\n\n";

// Test 1: Verify users and roles
echo "1️⃣ Testing User Roles and Authentication...\n";
